    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        encryptBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String after_encry_str =keyStoreUtils.getInstance().encryptString(need_deal_word_str,alias_str);
        ...
        decryptBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String after_decrypt_str =keyStoreUtils.getInstance().decryptString(before_decrypt_str, alias_str);
